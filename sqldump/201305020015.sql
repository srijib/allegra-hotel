...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2013 at 04:13 PM
...
(8, 1, 'user1'),
(8, 2, 'd41d8cd98f00b204e9800998ecf8427e'),
(8, 3, 'user1@gmail.com'),
(8, 4, 'Mr.'),
(8, 5, 'Alex'),
(8, 6, 'Smith'),
...
(1, 8, 21, 1, '2013-04-11 16:00:00', 2, 7, 1),
...
(2, 'aboutus_policy', 'Customers should always read this policy. Allegra Hotels is not responsible for any policy which the customers do not abide by. Our policies are there to ensure fair and equitable experience for all concerned.'),
...
(1, 8, '2013-04-24 10:09:00', 'unchecked-in', NULL),
(2, 9, '2013-04-30 12:38:00', 'unchecked-in', NULL),
(3, 9, '2013-05-01 15:00:00', 'unchecked-in', NULL),
(4, 8, '2013-03-14 11:00:00', 'checked-in', 'Good hotel, comfortable room and delicious breakfast.');
