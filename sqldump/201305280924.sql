...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2013 at 01:24 AM
...
--
-- Table structure for table `admin_has_meta`
--

CREATE TABLE IF NOT EXISTS `admin_has_meta` (
  `admin_id` int(10) unsigned NOT NULL,
  `meta_id` int(10) unsigned NOT NULL,
  `value` longtext CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`admin_id`,`meta_id`),
  KEY `meta_id` (`meta_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `admin_has_meta`
--

INSERT INTO `admin_has_meta` (`admin_id`, `meta_id`, `value`) VALUES
(1, 40, 'admin_user1'),
(1, 41, '1111'),
(2, 40, 'admin_user2'),
(2, 41, 'bbbb'),
...
(12, 9, 'Florida'),
(12, 10, 'Orlando'),
(12, 11, '45 Spring Hill Rd'),
(12, 35, '0'),
(21, 1, 'james'),
(21, 2, 'b59c67bf196a4758191e42f76670ceba'),
(21, 3, 'james@icloud.com'),
(21, 4, 'Mr.'),
(21, 5, 'James'),
(21, 6, 'May'),
(21, 7, '+861381922912'),
...
(40, 'admin_username', 'Admin Username', 'VARCHAR', 1, 1, NULL),
(41, 'admin_password', 'Admin Password', 'VARCHAR', 1, 1, NULL);
...
(9, 'slider_2', '2'),
(10, 'slider_3', '3'),
(11, 'contactus_phone', '(+61)3 9902 6128'),
(12, 'contactus_fax', '(+61) 3 9905 5419'),
(13, 'contactus_postal', '30 King''s Road, VIC 3162, Australia'),
...
--
-- Constraints for table `admin_has_meta`
--
ALTER TABLE `admin_has_meta`
  ADD CONSTRAINT `admin_has_meta_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`admin_id`),
  ADD CONSTRAINT `admin_has_meta_ibfk_2` FOREIGN KEY (`meta_id`) REFERENCES `meta` (`meta_id`);
